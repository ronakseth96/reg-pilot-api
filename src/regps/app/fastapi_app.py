...
@app.post("/add_root_of_trust", response_model=AddRootOfTrustResponse)
async def add_root_of_trust(
        request: Request,
        response: Response,
        data: AddRootOfTrustRequest,
):
    """
    Given a vLEI, adds the root of trust to the verifier
    """
    try:
